...
import { H5, FormGroup, Classes, Checkbox, NumericInput, InputGroup, Intent, HTMLSelect, TextArea } from '@blueprintjs/core';
...
function ObjectFieldTemplate(props) {
  ...
  }, React.createElement(H5, null, title), description, properties.map(function (element) {
    return React.createElement("div", {
      key: element.name,
...
function TextWidget(_ref) {
  ...
  var input = function () {
    ...
    switch (schema.type) {
      case 'string':
        return React.createElement(InputGroup, Object.assign({}, inputProps, {
          type: myOptions.inputType
        }));

      case 'number':
        return React.createElement(NumericInput, Object.assign({}, inputProps, {
      ...
      case 'integer':
        ...
        return React.createElement(NumericInput, Object.assign({
          minorStepSize: null,
          majorStepSize: null,
...
var _utils$getDefaultRegi = /*#__PURE__*/utils.getDefaultRegistry(),
...
var BPForm = /*#__PURE__*/withTheme(Theme);

export default BPForm;
export { FieldTemplate, Fields, ObjectFieldTemplate, Theme, Widgets };
//# sourceMappingURL=blueprintjs.esm.js.map
